...
import com.example.plantg.LoginActivity
import com.example.plantg.MainActivity
...
//            if (SliderViewpager.currentItem>=3)
        ...
        tvSkip.setOnClickListener {   Intent(applicationContext,MainActivity::class.java).also {
            startActivity(it)
            finish()
        }}
